...
FloatPlay `v1.1.1` is publicly available on the Chrome Web Store. This focused hotfix removes unreliable PiP hover dimming while preserving optional click-on-video Play/Pause.
